...
class ToxicityFilter:
    ...
    def __init__(self, text_train: pd.DataFrame, labels_train: pd.DataFrame):
        ...
        self.training = self.vectorizer.fit_transform(text_train)
        self.models = MultinomialNB().fit(self.training, labels_train)
    ...
    def classify (self, text_test: list[str]) -> list[int]:
        ...
        """
        text_message = self.vectorizer.transform(text_test)
        return self.models.predict(text_message)
