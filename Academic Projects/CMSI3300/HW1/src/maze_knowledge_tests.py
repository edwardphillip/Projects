...
#NOTE MY TESTS
    ...
    def test_inference_A(self) -> None:
        #    c-> 012345   # r
        maze = ["XXXXXX", # 0
                "X...GX", # 1
                "X..PPX", # 2
    ...
    def test_mazekb_A(self) -> None:
        kb = MazeKnowledgeBase()
        kb.tell(MazeClause([(("P", (2, 4)), False), (("P", (3, 3)), False), (("P", (1, 3)), False), (("P", (2, 2)), False)]))
        kb.tell(MazeClause([(("P", (2, 5)), False), (("P", (1, 4)), False)]))
        kb.tell(MazeClause([(("P", (2, 3)), False), (("P", (2, 5)), False)]))
        kb.tell(MazeClause([(("P", (2, 5)), False), (("P", (3, 4)), False)]))
        kb.tell(MazeClause([(("P", (3, 4)), False), (("P", (1, 4)), False)]))
        kb.tell(MazeClause([(("P", (2, 3)), True), (("P", (2, 5)), True), (("P", (3, 4)), True), (("P", (1, 4)), True)]))
        kb.tell(MazeClause([(("P", (2, 3)), False), (("P", (1, 4)), False)]))
        kb.tell(MazeClause([(("P", (2, 3)), False), (("P", (3, 4)), False)]))
        kb.tell(MazeClause([(("P", (2, 3)), False), (("P", (1, 2)), False), (("P", (1, 4)), False)]))
        
        self.assertEqual(True, kb.ask(MazeClause([(("P", (3, 4)), True)])))
