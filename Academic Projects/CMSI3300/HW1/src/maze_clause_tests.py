...
class MazeClauseTests(unittest.TestCase):
    ...
    def test_mazeclause_resolution_A(self) -> None:
        mc1 = MazeClause([(("P", (2, 4)), False), (("P", (3, 3)), False), (("P", (1, 3)), False), (("P", (2, 2)), False)])
        mc2 = MazeClause([(("P", (2, 5)), False), (("P", (1, 4)), False)])
        mc3 = MazeClause([(("P", (2, 3)), False), (("P", (2, 5)), False)])
        mc4 = MazeClause([(("P", (2, 5)), False), (("P", (3, 4)), False)])
        mc5 = MazeClause([(("P", (3, 4)), False), (("P", (1, 4)), False)])
        mc6 = MazeClause([(("P", (2, 3)), True), (("P", (2, 5)), True), (("P", (3, 4)), True), (("P", (1, 4)), True)])
        mc7 = MazeClause([(("P", (2, 3)), False), (("P", (1, 4)), False)])
        mc8 = MazeClause([(("P", (2, 3)), False), (("P", (3, 4)), False)])
        mc9 = MazeClause([(("P", (2, 3)), False), (("P", (1, 2)), False), (("P", (1, 4)), False)])
        res = MazeClause.resolve(mc1, mc2)
        self.assertEqual(0, len(res))
