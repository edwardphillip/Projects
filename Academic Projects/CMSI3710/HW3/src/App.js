...
const App = () => {
  ...
  return (
    <section className="App">
      ...
      <footer>
        <section>
          <button disabled={!universe} onClick={handleDay}>
            Day Time
          </button>
          <button disabled={!universe} onClick={handleSunset}>
            Sunset
          </button>
          <button disabled={!universe} onClick={handleNight}>
            Night Time
          </button>
        </section>
